...
public class SqlConstant {
    public static final String FOOD_INSERT = "INSERT INTO foods (nameFood, Categoryid, description, avatar, price," +
            "createdAt, updatedAt, deletedAt, createdBy, updatedBy, deletedBy, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    public static final String FOOD_UPDATE = "UPDATE foods SET nameFood = ?, Categoryid = ?, description = ?, avatar = ?, price = ?" +
    ...
    public static final String FOOD_FIELD_THUMBNAIL = "avatar";

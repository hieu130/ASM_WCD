...
public class MySqlFoodModel implements FoodModel{
    ...
    public boolean update(int id, Food food) {
        try {
            ...
            preparedStatement.setString(5,food.getAvatar());
    ...
    public Food findById(int id) {
        try {
            ...
            while (rs.next()){
                ...
                Food food = new Food(id,nameFood,description,price,avatar,createdAt,updatedAt,deletedAt,createdBy,updatedBy,deletedBy,foodStatus);
                return food;
            }
        }catch (SQLException e){
            System.out.println(e);
